      ...
      <div>
        ...
        <div style={{ marginTop: 12, display: "flex", flexDirection: "column", gap: 8, maxHeight: 360, overflowY: "auto" }}>
          ...
          {query.trim().length >= 2 && filtered.length === 0 && (
            <div style={{ color: "#8A7A94", fontSize: 13, background: "#FBF3E6", border: "1px dashed #E6D8C4", borderRadius: 12, padding: 14 }}>
          ...
          <div style={{ background: "#FBF3E6", border: "1px dashed #E6D8C4", borderRadius: 12, padding: 14 }}>
            <div style={{ color: "#2B1B2E", fontSize: 14, marginBottom: 8 }}>Add a new restaurant</div>
